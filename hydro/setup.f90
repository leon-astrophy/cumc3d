...
IF (DM_flag) THEN
    ...
    ALLOCATE(l1(imin1:imax1,-2:nx_1+3,-2:ny_1+3,-2:nz_1+3))
    ALLOCATE(u2_dm(imin1:imax1,-2:nx_1+3,-2:ny_1+3,-2:nz_1+3))
    ALLOCATE(u3_dm(imin1:imax1,-2:nx_1+3,-2:ny_1+3,-2:nz_1+3))
    ALLOCATE(l3_dm(imin1:imax1,-2:nx_1+3,-2:ny_1+3,-2:nz_1+3))
    ALLOCATE(u_old1(imin1:imax1,-2:nx_1+3,-2:ny_1+3,-2:nz_1+3))
    ALLOCATE(prim1(imin1:imax1,-2:nx_1+3,-2:ny_1+3,-2:nz_1+3))
    ALLOCATE(cons1(imin1:imax1,-2:nx_1+3,-2:ny_1+3,-2:nz_1+3))
    ALLOCATE(sa1(imin1:imax1,-2:nx_1+3,-2:ny_1+3,-2:nz_1+3))
	ALLOCATE(sb1(imin1:imax1,-2:nx_1+3,-2:ny_1+3,-2:nz_1+3))
