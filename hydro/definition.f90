...
REAL (DP), ALLOCATABLE, DIMENSION (:,:,:) :: phi1_x
REAL (DP), ALLOCATABLE, DIMENSION (:,:,:) :: phi1_y
...
REAL (DP), ALLOCATABLE, DIMENSION (:,:,:) :: phi2_x
REAL (DP), ALLOCATABLE, DIMENSION (:,:,:) :: phi2_y
REAL (DP), ALLOCATABLE, DIMENSION (:,:,:) :: phi2_z

! Lapse function !
REAL (DP), ALLOCATABLE, DIMENSION (:,:,:) :: alapse_2
...
REAL (DP), allocatable, DIMENSION (:,:,:,:) :: src1
REAL (DP), allocatable, DIMENSION (:,:,:,:) :: flx_1, fly_1, flz_1
REAL (DP), allocatable, DIMENSION (:,:,:,:) :: dfdx1, dfdy1, dfdz1 

! Flux arrays for NM !
REAL (DP), allocatable, DIMENSION (:,:,:,:) :: src2
REAL (DP), allocatable, DIMENSION (:,:,:,:) :: flx_2, fly_2, flz_2
REAL (DP), allocatable, DIMENSION (:,:,:,:) :: dfdx2, dfdy2, dfdz2
