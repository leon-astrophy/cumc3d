...
! write dataset !
call h5dwrite_f(dset_id1,H5T_NATIVE_DOUBLE,xF2(1:nx_2),dist_dims,error)
...
! write dataset !
call h5dwrite_f(dset_id1,H5T_NATIVE_DOUBLE,yF2(1:ny_2),dist_dims,error)
...
! write dataset !
call h5dwrite_f(dset_id1,H5T_NATIVE_DOUBLE,zF2(1:nz_2),dist_dims,error)
