...
REAL*8, PARAMETER :: x1_start = 1.5D0
REAL*8, PARAMETER :: y1_start = 0.0d0
REAL*8, PARAMETER :: z1_start = -60.0d0

! Ending position of the grid !
REAL*8, PARAMETER :: x1_end = 170.0d0
REAL*8, PARAMETER :: y1_end = 2.0d0*pi 
REAL*8, PARAMETER :: z1_end = 60.0d0
...
! Starting position of the grid !
REAL*8, PARAMETER :: x2_start = 1.5D0
REAL*8, PARAMETER :: y2_start = 0.0d0
REAL*8, PARAMETER :: z2_start = -5.0d0

! Ending position of the grid !
REAL*8, PARAMETER :: x2_end = 11.5
REAL*8, PARAMETER :: y2_end = 2.0d0*pi 
REAL*8, PARAMETER :: z2_end = 5.0d0 

! The number of grid in the x,y,z direction for NM
INTEGER, PARAMETER :: nx_2 = 128
INTEGER, PARAMETER :: ny_2 = 1
INTEGER, PARAMETER :: nz_2 = 128
...
! Use the PPM (Colella 1984, Mignone 2011 and 2014) reconstruction scheme !
LOGICAL, PARAMETER :: ppm1984_flag = .true.
LOGICAL, PARAMETER :: ppm2011_flag = .false.
LOGICAL, PARAMETER :: ppm2014_flag = .false.

! Use the WENO-Z reconstruction scheme !
LOGICAL, PARAMETER :: wenoz_flag = .false.
