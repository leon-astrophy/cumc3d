...
! Inner diode !
!DO CONCURRENT(j = nx_min_2:nx_part_2, k = 1:3, l = nz_min_2:nz_part_2)
!  prim2(ivel2_y,j,ny_min_2-k,l) = MIN(prim2(ivel2_y,j,ny_min_2-k,l), 0.0D0)
!ENDDO   

! Outer diode !
!DO CONCURRENT(j = nx_min_2:nx_part_2, k = 1:3, l = nz_min_2:nz_part_2)
!  prim2(ivel2_y,j,ny_part_2+k,l) = MAX(prim2(ivel2_y,j,ny_part_2+k,l), 0.0D0)
!ENDDO
