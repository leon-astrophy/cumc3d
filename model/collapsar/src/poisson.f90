...
+ (yp1+ym1-2.0d0*yc-2.0d0*TAN(yc))/xc**2/TAN(yc)/(yp1-yc)/(yc-ym1) &
- 2.0d0/xc**2/SIN(yc)**2/(zp1-zc)/(zc-zm1)
...
! assign !
betakp1 = (2.0d0*TAN(yc) + yc - ym1)/xc**2/TAN(yc)/(yp1 - yc)/(yp1 - ym1)
betakm1 = (2.0d0*TAN(yc) + yc - yp1)/xc**2/TAN(yc)/(yp1 - ym1)/(yc - ym1)

! assign !
gammalp1 = 2.0d0/xc**2/SIN(yc)**2/(zp1-zm1)/(zp1-zc)
gammalm1 = 2.0d0/xc**2/SIN(yc)**2/(zp1-zm1)/(zc-zm1) 
