...
DO l = 0, nz_2
  DO k = 0, ny_2
    DO j = 0, nx_2
      prim2(ibx,j,k,l) = -(A_corner(j,k,l) - A_corner(j,k,l-1))/dz2(l)
      prim2(ibz,j,k,l) = (xF2(j)*A_corner(j,k,l) - xF2(j-1)*A_corner(j-1,k,l))/dx2(j)/x2(j)
    END DO
  END DO
END DO
...
DO l = 1, nz_2
  DO k = 1, ny_2
    DO j = 1, nx_2
      div_b = (xF2(j)*prim2(ibx,j,k,l) - xF2(j-1)*prim2(ibx,j-1,k,l))/(x2(j)*dx2(j)) + & 
